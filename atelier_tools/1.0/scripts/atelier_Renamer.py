...
def atelier_UI():
    ...
    win = 'atelierRenamerWin'
    if cmds.window(win, ex=True):
        cmds.deleteUI(win)
    cmds.window(win, t='VFX Renamer', rtf=True)
    ...
    cmds.button(
        arbtt, e=True,
        c='atelier_Renamer.addRemoveString(\
    ...
    cmds.button(
        rfbtt, e=True,
        c='atelier_Renamer.replaceString(\
        cmds.checkBox("' + cbs + '", q=True, v=True),\
    ...
    cmds.button(
        nfbtt1, e=True,
        c='cmds.textField("' + nftc1 + '", e=True, tx=atelier_Renamer.getCurrentSel(["' + ('", "').join(presets) + '"]))')
    cmds.button(
        nfbtt2, e=True,
        c='atelier_Renamer.renumberString(\
        cmds.checkBox("' + cbs + '", q=True, v=True),\
    ...
    cmds.window(
        win, e=True,
        cc='atelier_Renamer.storeOptionVars("' + cbs + '", "' + cbb + '", "' + arcb + '", "' + arbtt + '", "' + artc + '", "' + rbgrf + '", "' + rftc1 + '", "' + rftc2 + '", "' + nftc1 + '", "' + nfif1 + '", "' + nfif2 + '", "' + flar + '", "' + flr + '", "' + flrn + '")')
    cmds.showWindow(win)
