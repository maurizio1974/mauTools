...
def gui_creation():
    ...
    translate_checkBoxes = pm.checkBoxGrp('translate_checkBoxes', ncb=4, cw4=(cbw, cbw, cbw, cbw),
                                          cc4=pm.Callback(set_checkBoxGrp, 'translate_checkBoxes'))
    pm.text(l='Rotation:')
    rotate_checkBoxes = pm.checkBoxGrp('rotate_checkBoxes', ncb=4, cw4=(cbw, cbw, cbw, cbw),
                                       cc4=pm.Callback(set_checkBoxGrp, 'rotate_checkBoxes'))
    pm.text(l='Scale: ')
    scale_checkBoxes = pm.checkBoxGrp('scale_checkBoxes', ncb=4, cw4=(cbw, cbw, cbw, cbw),
                                      cc4=pm.Callback(set_checkBoxGrp, 'scale_checkBoxes'))
    ...
    controlType_radioGrp = pm.radioButtonGrp(la4=['Ik', 'Fk', 'All', 'None'], nrb=4, cw4=(40, 40, 40, 40), sl=4,
                                             cc=set_controlType)
    pm.setParent(main_col)
