...
def sdd_weightTools():
    ...
    frameLayout('wtMainTypeFL',cll=0,cl=0,w=MainFLW,bv=1,lv=0,mh=3,mw=3)
...
####Paint Layout
    ...
    frameLayout('wtPaintTopFL',cll=0,cl=0,w=MainFLW,bv=1,lv=0,mh=3,mw=3)
    ...
    frameLayout('wtPaintBtmFL',cll=0,cl=0,w=MainFLW,bv=1,lv=0,mh=3,mw=3)
...
####Vertex Layout
    ...
    frameLayout('wtVtxLayoutFL',cll=0,cl=0,w=MainFLW,bv=1,lv=0,mh=3,mw=3)
