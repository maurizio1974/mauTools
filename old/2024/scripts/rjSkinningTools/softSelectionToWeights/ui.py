...
class SoftSelectionToWeightsWidget(ui.QWidget):
    ...
    def setEnableInfluence(self):
        ...
        for influence in influences:
            for mesh in list(influence.ssData.keys()):
    ...
    def skin(self):
        ...
        for influence in influences:
            ...
            # loop meshes
            for mesh, weights in soft.items():
                if not mesh in list(data.keys()):
                    data[mesh] = {}
                    
                # loop weights
                for index, weight in weights.items():
                    if not index in list(data[mesh].keys()):
                        data[mesh][index] = {}
                        
                    if not inf in list(data[mesh][index].keys()):
        ...
        self.progressBar.setMaximum(len(list(data.keys())))
