...
import RigBox3.rr_sub_curves_addAttributes
import RigBox3.rr_sub_curves_colorOptions
import RigBox3.rr_sub_curves_curveCreation
import RigBox3.rr_sub_curves_lockHide
...
def window_creation():
    ...
    window_object = pm.window(window_name, bgc=window_bgc, w=width, h=height, t='RigBox Reborn Curve Tool V3')
    gui_creation()
    window_object.show()
...
def gui_creation():
    ...
    RigBox3.rr_sub_curves_curveCreation.gui_creation()
    pm.setParent(main_scroll)

    create_frameLayout('Coloring')
    RigBox3.rr_sub_curves_colorOptions.gui_creation()
    pm.setParent(main_scroll)

    create_frameLayout('Attributes')
    RigBox3.rr_sub_curves_addAttributes.gui_creation()
    pm.setParent(main_scroll)

    create_frameLayout('Lock and Hide')
    RigBox3.rr_sub_curves_lockHide.gui_creation()
    pm.setParent(main_scroll)
