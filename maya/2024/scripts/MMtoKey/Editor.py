...
from . import Engine
from . import LanguageChange
from . import HotkeyMaker
import amUtils.UtilsQT as UtilsQT
from . import Version
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, engine):
        ...
        menu_file.addAction("clear cache", Engine.Menu.clearCache)
        ...
        self.menuBar().addMenu(menu_file)
        self.menuBar().addAction("about", lambda *args: UtilsQT.about(Version))
        self._update()
        self.show()
...
class Preferences(QMainWindow):
    ...
    def __init__(self, preferences):
        ...
        self.ui.chb_cache.setChecked(preferences["cache_mel"])
    ...
    def _save(self):
        ...
        self._preferences["cache_mel"] = self.ui.chb_cache.isChecked()
