...
class NodeAlignDeezUI(QtWidgets.QMainWindow):
    ...
    def _initAlignWidgets(self, layout):
        ...
        self.uiAlignXBTN.setSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        lay.addWidget(self.uiAlignXBTN)
        self.uiAlignYBTN = QtWidgets.QPushButton()
        self.uiAlignYBTN.setText('Align\nY')
        self.uiAlignYBTN.setSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
    ...
    def _initDistributeWidgets(self, layout):
        ...
        self.uiDistributeXBTN.setSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        lay.addWidget(self.uiDistributeXBTN)
        self.uiDistributeYBTN = QtWidgets.QPushButton()
        self.uiDistributeYBTN.setText('Distribute\nY')
        self.uiDistributeYBTN.setSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
    ...
    def _initStackWidgets(self, layout):
        ...
        self.uiStackXBTN.setSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        lay.addWidget(self.uiStackXBTN)
        self.uiStackYBTN = QtWidgets.QPushButton()
        self.uiStackYBTN.setText('Stack\nY')
        self.uiStackYBTN.setSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
    ...
    def _initCenterWidgets(self, layout):
        ...
        self.uiCenterXBTN.setSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        lay.addWidget(self.uiCenterXBTN)
        self.uiCenterBTN = QtWidgets.QPushButton()
        self.uiCenterBTN.setText('Center')
        self.uiCenterBTN.setSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        lay.addWidget(self.uiCenterBTN)
        self.uiCenterYBTN = QtWidgets.QPushButton()
        self.uiCenterYBTN.setText('Center\nY')
        self.uiCenterYBTN.setSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
    ...
    def initConnections(self):
        ...
        self.uiDistributeXBTN.clicked.connect(lambda : self.alignDeez.distributePosX())
        self.uiDistributeYBTN.clicked.connect(lambda : self.alignDeez.distributePosY())
        ...
        self.uiScaleSLDR.sliderPressed.connect(lambda : self.alignDeez.setItemsToBeScaled())
        self.uiScaleSLDR.sliderMoved.connect(lambda : self.alignDeez.scaleSetItems(self.uiScaleSLDR.value() * 0.01))
        self.uiScaleSLDR.sliderReleased.connect(lambda : self.uiScaleSLDR.setValue(0))
