...
def mSetWild():
    ...
    # ]
    uiP = [
        'mnmWildCB', 'mnmWildCB1','mnmMauRef', 'mnmMauRen',
        'mnmMauTools', 'mnmSetsManager', 'mnmPK', 'mnmPlugs'
    ]
    for u in uiP:
    ...
    cmds.iconTextButton(
        ...
        label='Set', w=33, h=33,
        i='mSET.png',
        c='import mSetManager as ms;import importlib;importlib.reload(ms);ms.mSetManager_UI()',
        p=gToolBox
    )
    cmds.iconTextButton(
        'mnmPK',
        label='PK', w=33, h=33,
        i='mAssetPack.png',
        c='import mAssetPack as mA;import importlib;importlib.reload(mA);mA.mAssetPackUI()',
        p=gToolBox
    )
    # cmds.iconTextButton(
    #     'mnmCH',
    #     l='PK', w=33, h=33,
    #     i='LOGO_rebrand.ico',
    #     c='import charPipeline;import importlib;importlib.reload(charPipeline);import cachePipeline;import importlib;importlib.reload(cachePipeline);cachePipeline.aToolsUI()',
    #     p=gToolBox
    # )
    cmds.button(
        'mnmMauRef',
        label='mRef', w=33, h=20,
        c='import mWild as mW;import importlib;importlib.reload(mW);mW.mReferenceEditor();',
        p=gToolBox
    )
    cmds.button(
        'mnmPlugs',
