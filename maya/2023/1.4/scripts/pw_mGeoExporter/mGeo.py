...
import importlib
# if qt == 'qt':
#     from . import widgets.mGeo_UI as ui
if qt =='side':
    from . import widgets.mGeo_UIs as ui
else:
    from . import widgets.mGeo_UIs2 as ui

importlib.reload(ui)
from . import exportSetManager
importlib.reload(exportSetManager)
from . import pw_settings as stngs
from . import mGeoReader
importlib.reload(mGeoReader)
importlib.reload(mddWriter)
importlib.reload(alembicWriter)
from .widgets import warningDialog as wd
from .widgets import attribTableWidget, pathLineEdit
importlib.reload(attribTableWidget)
importlib.reload(pathLineEdit)
from .presets import mgeo_presets
importlib.reload(mgeo_presets)
