...
def getListPic():
    ...
    pathImage = os.path.join(os.getenv('MAUT'), 'framingAssistant/pictures')
...
class MainWindow(MayaQWidgetBaseMixin, QtWidgets.QMainWindow):
    def __init__(self, parent=None):
        ...
        UIFILEPATH = os.path.join(os.getenv('MAUT'), 'framingAssistant/gui/mainWindow.ui')
        ...
        self.pathImage = os.path.join(os.getenv('MAUT'), 'framingAssistant/pictures')
    ...
    def userChangePic(self):
        ...
        self.selectedPic = str(self.UI.listPic.currentItem().text())
        print (self.pathImage + '//' + self.selectedPic + '.png')
        self.UI.preview.setPixmap(self.pathImage + '//' + self.selectedPic + '.png')
        if self.UI.imagePlane.text():
            imagePlaneShape = str(cmds.listRelatives(self.UI.imagePlane.text(), ad=0, s=1)[0])
            try:
