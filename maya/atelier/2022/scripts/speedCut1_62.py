...
def jwSpeedCutUI():
    ...
    mc.scrollLayout()
    mc.columnLayout()
    mc.frameLayout( cll= 1, cl= 0, label= "Mesh Setup" ,  bgc =[0.14,0.14,0.14] , w= 300)
    ...
    #######################################################################################################################################################################################
    mc.frameLayout( cll= 1, cl= 0, label= "Mesh Symmetry" ,   bgc =[0.14,0.14,0.14] , w= 300)
    buttonSize = 25
    ...
    mc.setParent( '..' )
    #######################################################################################################################################################################################
    mc.frameLayout( cll= 1, cl= 0, label= "Cutter" ,  bgc = [0.14,0.14,0.14] , w= 300)
    ...
    mc.setParent( '..' )
    ########################################################################################################################################################################
    mc.frameLayout(cll= 1, cl= 0, label= "Control" ,  bgc = [0.14,0.14,0.14]  , w= 300)
    mc.rowColumnLayout(nc=6, cw=[(1,40),(2,80),(3,5),(4,80),(5,5),(6,80)])
    mc.text(l ='',h=20)
    ...
    mc.setParent( '..' )
    ########################################################################################################################################################################
    mc.frameLayout( cll= 1, cl= 0, label= "Alignment" ,  bgc = [0.14,0.14,0.14] , w= 300)
    ...
    mc.setParent( '..' )
    ########################################################################################################################################################################
    mc.frameLayout(cll= 1, cl= 0, label= "Pattern" ,  bgc = [0.14,0.14,0.14]  , w= 300)
    mc.rowColumnLayout(nc=8, cw=[(1,40),(2,50),(3,5),(4,50),(5,5),(6,50),(7,10),(8,80)])
    mc.text(l ='Type',h=20)
    ...
    mc.setParent( '..' )
    ##########################################################################################################################################################################
    mc.frameLayout(cll= 1, cl= 0, label= "Live Draw" ,  bgc = [0.14,0.14,0.14]  , w= 300)
    ...
    mc.setParent( '..' )
    ##########################################################################################################################################################################
    mc.frameLayout(cll= 1, cl= 0, label= "Bake" ,  bgc = [0.14,0.14,0.14]  , w= 300)
    mc.rowColumnLayout(nc=6, cw=[(1,40),(2,80),(3,5),(4,80),(5,5),(6,80)])
    mc.text(l ='',h=10)
    ...
    mc.setParent( '..' )
    mc.setParent( '..' )
    mc.frameLayout(cll= 1, cl= 0, label= "Mesh Bevel Manager" ,  bgc = [0.14,0.14,0.14]  , w= 300)
...
def evenObjLineUp(dir):
    ...
    if dir == 'x' :
        score = OrderedDict(sorted(list(dataX.items()), key = lambda fd: fd[1],reverse = False))
    else:
        score = OrderedDict(sorted(list(dataY.items()), key = lambda fd: fd[1],reverse = False))
